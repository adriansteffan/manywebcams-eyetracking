...
### Visualizing the eye tracking data 

To visualize the eye tracking data of each participant and facilitate the pre-screening of participant videos, you can use the script provided in the `data-processing` directory. 
